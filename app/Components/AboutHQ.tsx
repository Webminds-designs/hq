                            ...
                            <div className="flex flex-wrap justify-center gap-4 md:gap-6 w-full">
                                {teamMembers.slice(0, 4).map((member, index) => (
                                    <div key={index} className="flex flex-col items-center">
                                        <div
                                            className="bg-white rounded-[4.88px] shadow-lg w-[160px] xs:w-[180px] sm:w-[180px] md:w-[200px] lg:w-[220px] h-[230px] xs:h-[250px] sm:h-[260px] md:h-[280px] lg:h-[310px] transition-all"
                                        >
                                            <div className="p-2 h-full flex flex-col">
                                                ...
                                                <div className="mt-3 bg-white rounded-[4.88px] text-left px-1">
                                                    <p className="font-avenir text-xs sm:text-sm font-medium text-black">{member.name}</p>
