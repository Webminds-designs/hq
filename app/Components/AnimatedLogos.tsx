...
export default function Component() {
    ...
    return (
        <div className="w-full bg-[#0f0f10] py-16 overflow-hidden">
                    ...
                    >
                        ...
                        <div className="flex gap-12">
                            {firstRow.map((logo, index) => (
                                <div key={`first-${index}`} className="w-64 h-32 relative flex items-center justify-center">
                        ...
                        <div className="flex gap-12">
                            {firstRow.map((logo, index) => (
                                <div key={`first-dup-${index}`} className="w-64 h-32 relative flex items-center justify-center">
                                    <div className="relative w-full h-full">
                                        <Image src={logo.src || "/placeholder.svg"} alt={logo.alt} fill className="object-contain" />
                                    </div>
                                </div>
                    ...
                    >
                        ...
                        <div className="flex gap-16">
                            {secondRow.map((logo, index) => (
                                <div key={`second-${index}`} className="w-64 h-32 relative flex items-center justify-center">
                                    <div className="relative w-full h-full">
                                        <Image src={logo.src || "/placeholder.svg"} alt={logo.alt} fill className="object-contain" />
                                    </div>
                                </div>
                        ...
                        <div className="flex gap-16">
                            {secondRow.map((logo, index) => (
                                <div key={`second-dup-${index}`} className="w-64 h-32 relative flex items-center justify-center">
                                    <div className="relative w-full h-full">
                                        <Image src={logo.src || "/placeholder.svg"} alt={logo.alt} fill className="object-contain" />
                                    </div>
                                </div>
